      ...
      <div className="h-screen bg-[url(/home-bg.png)] p-2">
        <div className="flex flex-col justify-center gap-4 pt-20 ml-20">
          ...
          <p className="text-lg text-gray-600 max-w-[700px]">
            ...
            trash, reducing environmental impact and making recycling easier
            than ever. Simply upload a photo or describe your waste, and let AI
            guide you to the best disposal method.
          </p>
          <Link
            to="/auth/login"
